...
public class Main {
	...
	public static void main(String[] args) {
		...
		pessoa.setCidade(JOptionPane.showInputDialog(null, "Digite a cidade onde você mora:"));
		
		//utilizando o método para verificar a idade da pessoa
		
		PessoaDAO daoIdade = new PessoaDAO();
		
		daoIdade.revisaIdade(pessoa.getIdade());
		
		//usando o método para verificar a cidade que o usuário digitar
